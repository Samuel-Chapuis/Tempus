...
void generationposition(bric **carte,int TC,int roughness,int HI,int joueurs); //Permet de placer les première villes et unités des joeur sur le plateau (revoi 0 si l'éxecution c'est passé sans erreurs)
